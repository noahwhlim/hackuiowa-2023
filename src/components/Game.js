...
export const Game = (props) => {
    ...
    const options = [
      {  label: 'Auto - Collision', value: 'Covers collision damages to your vehicle from any source regardless of fault. Required for people with a car lease or loan. Recommended for people who wouldn\'t be able to afford out of pocket repairs if the car is damaged.', key:[0]}, // Collision
      {  label: 'Auto - Comprehensive', value: 'Covers damages to your vehicle from non-collision events such as vandalism or natural disasters. Required for people with a car lease or loan. Recommended for people who wouldn\'t be able to afford out of pocket repairs if the car is damaged', key:[1]}, //Comprehensive
      ...
      {  label: 'Home - HO-8', value: 'Insurance designed to protect older homes, typically those more than 40 years old. Often applicable for historic homes and registered landmarks. These homes are a special case because their cost of repair often far exceeds their market value. Covers against fire/lightning, windstorm/hail, explosion, riot/civil commotion, damage from aircraft, damage from vehicles, smoke, vandalism, theft, and volcanic eruptions. Additionally covers liability, medical payments to others injured by your property, and additional living expenses incurred by the property.', key:[16]}, //HO-8
      {  label: 'Life - Burial', value: 'Covers expenses relating to your burial in the event of your death. Covers expenses such as a funeral, burial, and outstanding medical bills. Coverage typically has a low cap and especially if you die close to when the insurance was taken out your beneficiaries might not receive the full benefit. Recommended for people who want to have their burial covered after death.', key:[6]}, //Burial
      {  label: 'Life - Term', value: 'Replaces your income for your beneficiaries in the event of your death. Typically purchased in lengths of 5, 10, 15, 20, 25, or 30 years. Recommended for most people looking to acquire life insurance.', key:[7]}, //Term
      {  label: 'Life - Universal', value: 'Covers your entire life, but flexes to meet your needs over time. Allows for adjustable premiums, although generally requires that premiums increase over life. The drawback is that payout isn’t as guaranteed as it would be with whole insurance. Has a guaranteed return rate on the policy’s value. Recommended for people who want a plan that covers their entire life, but with more flexibility than whole life insurance.', key:[8]}, //Universal
      {  label: 'Life - Variable', value: 'A type of cash value life insurance, in which part of your premium goes to investments. Has a fixed premium and guaranteed payout regardless of the market, but payout can increase when the market does well. Recommended for people who have a higher risk tolerance.', key:[9]}, //Variable
      {  label: 'Life - Whole', value: 'Covers your entire life, but typically has a higher premium. Has a guaranteed return rate on the policy’s value. Recommended for people who just want a straightforward life insurance plan and don’t mind paying the higher premium.', key:[10]}, //Whole
